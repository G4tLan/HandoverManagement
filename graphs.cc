...
RoutingExperiment::Run (int nSinks, double txp, std::string CSVfileName)
{
  ...
  NodeContainer adhocNodes;
	...
	pos.Set("X", StringValue("ns3::UniformRandomVariable[Min=0.0|Max=1000.0]")), pos.Set(
			"Y", StringValue("ns3::UniformRandomVariable[Min=0.0|Max=1000.0]")), pos.Set(
	...
	std::cout << "  Offered Load: "
			<< stats[1].txBytes * 8.0
					/ (stats[1].timeLastTxPacket.GetSeconds()
							- stats[1].timeFirstTxPacket.GetSeconds()) / 1000
			<< " Kbps" << std::endl;
	...
	std::cout << "  Throughput: "
			<< stats[1].rxBytes * 8.0
					/ (stats[1].timeLastRxPacket.GetSeconds()
							- stats[1].timeFirstRxPacket.GetSeconds()) / 1000
			<< " Kbps" << std::endl;
	std::cout << "  Mean delay:   "
	...
	Simulator::Destroy();
	monitor->SerializeToXmlFile("manet-routing-compare.xml", true, true);
}
